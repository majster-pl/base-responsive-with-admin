...
<head>
    ...
    <title>{{ config('app.name', 'Your New WebApp') }}</title>
        ...
        <div x-bind:class="! menu_open ? '-left-60' : 'left-[0.2px]'" @click.outside="menu_open = false"
            ...
            <div class="p-2">
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('home') }}">
                        <img class="max-w-full h-auto" src="{{ asset('images/logo.svg')}}"
            ...
            <div class="absolute bottom-0">
                <div class="pt-4 pb-1 px-2">
                    <span class="text-xs text-gray-500">{{ config('app.name', 'Your New WebApp') }} v{{ env('APP_VER', 'n/a') }}</span>
                </div>
            </div>
        </div>
